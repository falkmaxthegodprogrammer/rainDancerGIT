...
public class TestProjectile extends Projectile {
	...
	public TestProjectile(Sprite sprite, Vector2f origin, int size, double dir) {
	...
	public TestProjectile(Sprite sprite, Vector2f origin, int size, double dir, Entity e) {
